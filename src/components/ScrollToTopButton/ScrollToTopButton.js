...
function ScrollToTopButton(props) {
  ...
  return (
    <>
      <div className={`scrollTop text-yellow-600 bg-black rounded-full pl-1 pr-5 p-6`} onClick={scrollTop} style={{ height: 40, display: showScroll ? 'flex' : 'none', marginBottom: props.showBig ? '20rem' : '4rem' }}
      >
